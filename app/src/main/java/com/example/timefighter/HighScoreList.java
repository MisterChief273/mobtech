...
public class HighScoreList extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.sub1) {
            Intent i = new Intent(HighScoreList.this, MainActivity.class);
            startActivity(i);
            finish();
            return true;
        }
        else if (id == R.id.sub2) {
            Intent i = new Intent(HighScoreList.this, HighScoreList.class);
            startActivity(i);
            finish();
            return true;
        }
            ...
            Intent i = new Intent(HighScoreList.this, Credits.class);
            startActivity(i);
            finish();
            return true;
        }
